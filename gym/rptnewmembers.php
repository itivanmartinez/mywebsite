...
<div class="container">
    <div class="row">
        <div class="col-2"></div>
        <div class="col-10"><br><br><h4>Date: <span id="date" ><?php echo date("F j, Y");?></span></h4></div>
        <div class="col-2"></div>
        <div class="col">
...
$sqlquery="SELECT * FROM tblmember m JOIN tblmembershipreg mr ON m.id=mr.CustomerID WHERE mr.CanDate IS NULL ORDER BY mr.RegDate desc LIMIT 5 ";
...
<table class="table table-striped">
    ...
    <tbody>
        ...
        while($row=mysqli_fetch_array($result)){
            ...
            echo "<td class='text-capitalize'>".$row['State']."</td>";
