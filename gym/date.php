...
<div class="container">
    <div class="row">
        <div class="col">
            <div class="float-left"><h4>Date: <span id="date" ></span></h4></div>
...
<div class="row">
    ...
    <div class="col-4">
        ...
        <p><span class="font-weight-bold">Member Since: </span><span class="font-italic"><?php echo date('d/m/Y', strtotime($memberDateJoined));?><br>
    </div>
        <div class="col-4">
